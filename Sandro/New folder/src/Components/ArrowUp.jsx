...
const ArrowUp = () => {
  ...
  return (
    <div
      id="jumberi"
      className="opacity-0 z-50 cursor-pointer hover:text-black duration-[400ms] ease-in-out h-[50px] lg:h-[75px] w-[50px] lg:w-[75px] bg-[#00df9a] fixed ml-[90%] mt-[500px] rounded-[100%] flex items-center justify-center"
    >
