...
const ArrowUp = () => {
  ...
  window.addEventListener('scroll', ()=>{
    if (window.pageYOffset > 50){
        document.getElementById('jumberi').style.visibility = 'visible'
    } else {
        document.getElementById('jumberi').style.visibility = 'hidden'
    }
})
...
scrollClick.addEventListener('click', (e)=>{
  ...
  return (
    <div id='jumberi' className='invisible z-50 cursor-pointer hover:text-black duration-[400ms] ease-in-out h-[50px] lg:h-[75px] w-[50px] lg:w-[75px] bg-[#00df9a] fixed ml-[90%] mt-[500px] rounded-[100%] flex items-center justify-center'>
