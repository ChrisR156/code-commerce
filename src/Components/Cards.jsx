...
const Cards = () => {
  return (
    <div className="h-[200vh] md:h-[100vh] w-[100%] bg-white flex justify-center items-center">
      <div className="flex flex-col items-center md:flex-row w-[100%] justify-center">
        <div className="h-[380px] md:h-[400px] w-[300px] md:w-[350px] rounded-2xl shadow-xl bg-white hover:scale-105 duration-300 hover:bg-[#fcfcfc]">
        <img className="w-24 mt-[-3rem] mb-2 mx-auto" src={Single} alt="/" />
          <div className="wrapper h-[90%] w-[100%] flex items-center justify-center flex-col">
            <div className="h-[30px] md:h-[40px] w-[100px] md:w-[140px] mb-6 text-center text-black font-bold text-2xl ">Single User</div>
        ...
        <div className="h-[380px] md:h-[400px] w-[300px] md:w-[350px] rounded-2xl shadow-xl my-16 mx-8 bg-white hover:scale-105 duration-300 hover:bg-[#fcfcfc]">
        ...
        <img className="w-24 mt-[-3rem] mb-2 mx-auto" src={Triple} alt="/" />
          <div className="wrapper h-[90%] w-[100%] flex items-center justify-center flex-col">
            <div className="h-[30px] md:h-[40px] w-[100px] md:w-[140px] mb-6 text-center text-black font-bold text-2xl ">Group Account</div>
